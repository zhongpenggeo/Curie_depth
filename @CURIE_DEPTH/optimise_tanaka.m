function [zt,zt_i,zo,zo_i]=optimise_tanaka(obj,K,ln_P,zt_k0, zt_k1,zo_k0,zo_k1)
% computer curie depth according to Tanaka(1999);
%
% -----------------input--------------------
% K : wave number km^-1;
...
% zo_i: intercept of zo
    ...
    fit_lnP_zo=log(exp(lnP_zo)./(2*pi*K_zo))/2/pi;
